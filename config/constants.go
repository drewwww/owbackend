...
type constants struct {
	...
	ListenAddressHTTP string   `envconfig:"SERVER_ADDR_HTTP" default:"overwatchstadium.ddns.net:8082" doc:"Address to serve HTTP on."`
	PublicAddress     string   `envconfig:"PUBLIC_ADDR" doc:"Publicly accessible address for the server, requires schema"`
	OpenIDRealm       string   `envconfig:"SERVER_OPENID_REALM" default:"http://overwatchstadium.ddns.net:8081" doc:"The OpenID Realm (See: [Section 9.2 of the OpenID Spec](https://openid.net/specs/openid-authentication-2_0-12.html#realms))"`
	AllowedOrigins    []string `envconfig:"ALLOWED_ORIGINS" default:"*"`
	CookieDomain      string   `envconfig:"SERVER_COOKIE_DOMAIN" default:"" doc:"Cookie URL domain"`
	LoginRedirectPath string   `envconfig:"SERVER_REDIRECT_PATH" default:"http://overwatchstadium.ddns.net:8080/" doc:"URL to redirect user to after a successful login"`
	...
	SteamDevAPIKey string `envconfig:"STEAM_API_KEY" default:"5179611B3F3847415971BB2F119EB859" doc:"Steam API Key"`
...
func init() {
	...
	if Constants.PublicAddress == "" {
		Constants.PublicAddress = "https://overwatchstadium.ddns.net:8081"
	}
